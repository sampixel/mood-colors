" Filename:     wintenvim.vim/autoload/lightline/colorscheme/wintenvim.vim
...
let s:keyword    = ["#af87d7", 140]
let s:operator   = ["#00afd7", 38]
let s:function   = ["#5f5fff", 63]
let s:comment    = ["#3f434c", 240]
let s:string     = ["#87ff87", 120]
let s:number     = ["#00ffd7", 50]
...
let g:lightline#colorscheme#wintenvim#palette = lightline#colorscheme#flatten(s:p)
