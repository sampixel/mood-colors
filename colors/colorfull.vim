...
let keyword     = {"gui": "#ff4f4f", "cui": 140}
let operator    = {"gui": "#6d26b7", "cui": 38}
let function    = {"gui": "#1786e7", "cui": 63}
let comment     = {"gui": "#3f434c", "cui": 240}
let string      = {"gui": "#84f05f", "cui": 120}
let number      = {"gui": "#ff9c00", "cui": 50}
